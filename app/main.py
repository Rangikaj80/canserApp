...
def get_radar_chart(input_data):
    ...
    categories = ['Radius','Texture','Perimeter','Area',
                  ...
                  'Concave Points', 'Symetry', 'Fractal Dimension'
                ]
...
def add_predictions(input_data):
    ...
    if prediction[0] == 0:
        ...
        st.write("<span class='diagnosis bright-red'>Malicious</span>", unsafe_allow_html=True)
...
def main():
    ...
    with st.container():
        ...
        st.write("Please connect this app to your cytology lab to help diagnose breast cancer form your tissue sample."
                  ...
                  "the measurements it receives from your cytosis lab. You can also update the measurements by hand using the sliders "
                  "in the sidebar.")
